...
<div class="container mt-4">
    <h2>Inbound Inventory History</h2>
    <a href="inbound.php" class="btn btn-secondary mt-3">Return to Inbound</a>
...
$(document).ready(function() {
    function loadInboundHistory() {
        ...
        $.ajax({
            url: "fetch_inbound_history.php",
            type: "GET",
            data: formData,
            beforeSend: function() {
                $("#inbound-data").html("<tr><td colspan='11' class='text-center'>Loading...</td></tr>");
            },
            success: function(response) {
                $("#inbound-data").html(response);
            },
            error: function() {
                $("#inbound-data").html("<tr><td colspan='11' class='text-center'>Error loading data.</td></tr>");
            }
        });
    }
    ...
    loadInboundHistory(); // Load data initially
});
</script>
