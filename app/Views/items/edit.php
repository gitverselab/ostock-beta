...
<div class="mb-6">
    <h2 class="text-2xl font-bold text-slate-800">Edit Item</h2>
    <p class="mt-1 text-sm text-slate-500">
        Update the selected item record.
    </p>
</div>
...
<form method="POST" action="/items/edit" class="space-y-6">
    ...
    <div class="grid gap-6 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 md:grid-cols-2">
        <div class="md:col-span-2">
            ...
            <input
                type="text"
                name="name"
                value="<?= htmlspecialchars((string) ($item['name'] ?? '')) ?>"
                required
        ...
        <div>
            ...
            <input
                type="text"
                name="item_code"
                value="<?= htmlspecialchars((string) ($item['item_code'] ?? '')) ?>"
                required
                class="w-full rounded-xl border border-slate-300 px-4 py-2.5 text-sm outline-none transition focus:border-slate-500 focus:ring-2 focus:ring-slate-200"
            >
        </div>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input
                    ...
                    min="0"
                    name="cost"
                    value="<?= htmlspecialchars((string) ($item['cost'] ?? '0')) ?>"
        ...
        <div>
            ...
            <input
                ...
                value="<?= htmlspecialchars((string) ($item['primary_uom_label'] ?? '')) ?>"
                required
                class="w-full rounded-xl border border-slate-300 px-4 py-2.5 text-sm outline-none transition focus:border-slate-500 focus:ring-2 focus:ring-slate-200"
            >
        </div>
        ...
        <div>
            ...
            <input
                ...
                value="<?= htmlspecialchars((string) ($item['secondary_uom_label'] ?? '')) ?>"
                required
                class="w-full rounded-xl border border-slate-300 px-4 py-2.5 text-sm outline-none transition focus:border-slate-500 focus:ring-2 focus:ring-slate-200"
            >
        </div>
        ...
        <div class="md:col-span-2">
            ...
            <input
                type="text"
                name="uom"
                value="<?= htmlspecialchars((string) ($item['uom'] ?? '')) ?>"
                required
                class="w-full rounded-xl border border-slate-300 px-4 py-2.5 text-sm outline-none transition focus:border-slate-500 focus:ring-2 focus:ring-slate-200"
            >
        </div>
        ...
        <div class="md:col-span-2">
            <label class="inline-flex items-center gap-3 rounded-xl bg-slate-50 px-4 py-3 text-sm text-slate-700">
                <input
                    ...
                    value="1"
                    <?= ((int) ($item['is_calendar_item'] ?? 0) === 1) ? 'checked' : '' ?>
