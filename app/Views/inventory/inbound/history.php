...
<div class="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
    <div>
        <h2 class="text-2xl font-bold text-slate-800">Inbound Inventory History</h2>
        <p class="mt-1 text-sm text-slate-500">
            Filter inbound inventory records by item, warehouse, and date received.
        </p>
    </div>
...
<form method="GET" action="/inventory/inbound/history" class="mb-6 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
